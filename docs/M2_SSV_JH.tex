...
\emph{alignSpectra()} est performant mais rencontre des limites sur les pics de faible ratio signal sur bruit, comme nous pouvons le voir sur la figure @ref(lav\_align). Le bruit intensifie l'effet vaguelette et génère de l'ambiguïté sur le nombre de pics présent. Par ailleurs, la fonction créé des pics négatifs qui faussent le calcul de l'AUC.
...
De plus, Jean-Michel Roger m'a proposé une approche basé sur l'algorithme COVSEL \autocite{roger_2011} pour résoudre notre problème.

\hypertarget{muxe9thodes-multivariuxe9es}{%
\section{Méthodes multivariées}\label{muxe9thodes-multivariuxe9es}}
