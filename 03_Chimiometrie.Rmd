...
La MCR est une famille de méthodes qui cherche à décomposer l'ensemble des spectres en plusieurs sous-ensembles de produits pures. La figure \@ref(schMCR) issue de l'article de @dejuan_2014 permet de bien comprendre l'objectif d'une MCR. La matrice D, obtenue par l'expérience, est l'expression de deux produits pures S~A~^T^ et S~B~^T^ (deux bouquets de COV pour notre PTR-ToF-MS) de concentration C~A~ et C~B~, qui sont les quatre vecteurs que nous cherchons à connaître^[et dont nous ne connaissons rien.]. Les étapes de l'équation sont décrites dans l'article précédemment citée.  
...
- l'ambigüité de **permutation**. Il n'y a pas d'ordre dans les spectres pures et leure concentration associée. Le spectre S~i~^T^ ne représente pas plus ou moins l'ensemble du jeu de donnée que le spectre S~j~^T^.  
