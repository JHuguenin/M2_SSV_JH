...
Merci aussi à ceux qui m'ont ajouter du travail durant cette année : Ngoc qui fut une brillante élève de conduite supervisée et qui n'a failli nous tuer que deux fois, à Batro pour avoir eu la brillante idée de synchronisé la date de sortie de notre jeu[@artho_2020] avec la date du deuxième confinement, et aux créatures de la nuit qu'il faut nourrir d'idées nouvelles chaque semaine.   
...
PTR-ToF-MS : Proton Transfert Reaction Time of Flight Mass Spectroscopy. Acronyme utilisé pour l'instrument de mesure (l**e** PTR-ToF-M**Spectrometer**) et pour la méthode d'analyse (l**a** PTR-ToF-M**Spectroscopy**). Par abus de langage, l'acronyme PTR-MS est régulièrement utilisé à l'oral.  
